# Célula única - Criar todos os arquivos e baixar
import os

# Criar estrutura
os.makedirs('videowall_project/.github/workflows', exist_ok=True)

# 1. Criar o código Python
codigo_python = '''#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""
...
with open('videowall_project/videowall_noc.py', 'w', encoding='utf-8') as f:
...
jobs:
  build:
    ...
    - name: Build executable
      run: pyinstaller --onefile --windowed --name "VideoWall_NOC" videowall_noc.py
    
    - name: Upload artifact
      uses: actions/upload-artifact@v4
      with:
        name: VideoWall_NOC_Windows
        path: dist/VideoWall_NOC.exe
'''

with open('videowall_project/.github/workflows/build.yml', 'w') as f:
    f.write(workflow)
